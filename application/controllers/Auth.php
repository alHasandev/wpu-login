...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            // siapkan token untuk mengaktifkan email
            ...
            // mengirim email aktivasi ke email new registrasi user
            $this->_sendEmail($token, 'verify');

            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Congratulation! your account has been created. Please check your email for activate your account</div>');
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => '0ne.forall99user@gmail.com',
            'smtp_pass' => 'doelh4<<<',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
        ...
        $this->email->from('0ne.forall99user@gmail.com', 'Al Hasan dev');
    ...
    public function changePassword()
    {
        ...
        $this->form_validation->set_rules('password2', 'Re-Password', 'trim|required|min_length[3]|matches[password1]');
